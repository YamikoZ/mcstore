...
function openBuyModal(btn) {
    ...
    var iStyle = 'width:100%;padding:9px 12px;border-radius:10px;background:rgba(255,255,255,0.06);border:1px solid rgba(255,255,255,0.12);color:inherit;font-size:14px;box-sizing:border-box;outline:none;';
    var html = '<div style="display:flex;flex-direction:column;gap:12px;text-align:left;font-size:14px;">';

    // Price card
    html += '<div style="display:flex;align-items:center;justify-content:space-between;padding:12px 16px;background:linear-gradient(135deg,rgba(255,255,255,0.06),rgba(255,255,255,0.02));border:1px solid rgba(255,255,255,0.1);border-radius:12px;">';
    html += '<span style="opacity:0.55;font-size:13px;">\u0e23\u0e32\u0e04\u0e32\u0e2a\u0e34\u0e19\u0e04\u0e49\u0e32</span>';
    html += '<div style="display:flex;align-items:center;gap:8px;">';
    html += '<strong style="color:var(--color-accent);font-size:20px;letter-spacing:-0.5px;">' + formatMoney(price) + '</strong>';
    if (isOnePerUser) {
        html += '<span style="font-size:10px;background:rgba(239,68,68,0.18);color:#f87171;padding:3px 8px;border-radius:20px;border:1px solid rgba(239,68,68,0.25);">\u0e0b\u0e37\u0e49\u0e2d\u0e44\u0e14\u0e49\u0e04\u0e23\u0e31\u0e49\u0e07\u0e40\u0e14\u0e35\u0e22\u0e27</span>';
    }
    html += '</div></div>';
    ...
    // Gift toggle
    html += '<label style="display:flex;align-items:center;gap:10px;cursor:pointer;padding:12px 14px;background:rgba(255,255,255,0.03);border:1px solid rgba(255,255,255,0.08);border-radius:12px;margin:0;transition:background 0.2s;" onmouseover="this.style.background=\'rgba(255,255,255,0.06)\'" onmouseout="this.style.background=\'rgba(255,255,255,0.03)\'">';
    html += '<input type="checkbox" id="swal-gift" onchange="shopToggleGift()" style="width:17px;height:17px;flex-shrink:0;cursor:pointer;accent-color:var(--color-primary);">';
    html += '<div><div style="font-size:13px;font-weight:500;"><i class="fas fa-gift" style="color:var(--color-accent);margin-right:6px;"></i>\u0e2a\u0e48\u0e07\u0e40\u0e1b\u0e47\u0e19\u0e02\u0e2d\u0e07\u0e02\u0e27\u0e31\u0e0d\u0e43\u0e2b\u0e49\u0e40\u0e1e\u0e37\u0e48\u0e2d\u0e19</div>';
    html += '<div style="font-size:11px;opacity:0.4;margin-top:2px;">\u0e23\u0e30\u0e1a\u0e38 username \u0e1c\u0e39\u0e49\u0e17\u0e35\u0e48\u0e15\u0e49\u0e2d\u0e07\u0e01\u0e32\u0e23\u0e2a\u0e48\u0e07</div></div>';
    html += '</label>';

    // Gift input
    html += '<div id="gift-section" style="display:none;animation:fadeIn 0.2s ease;">';
    html += '<label style="font-size:12px;opacity:0.55;display:block;margin-bottom:6px;"><i class="fas fa-user" style="margin-right:4px;"></i>\u0e0a\u0e37\u0e48\u0e2d\u0e1c\u0e39\u0e49\u0e40\u0e25\u0e48\u0e19\u0e17\u0e35\u0e48\u0e23\u0e31\u0e1a\u0e02\u0e2d\u0e07\u0e02\u0e27\u0e31\u0e0d</label>';
    html += '<input type="text" id="swal-gift-to" placeholder="username \u0e43\u0e19\u0e40\u0e01\u0e21" style="' + iStyle + '">';
    html += '<div style="display:flex;align-items:center;gap:5px;margin-top:6px;font-size:11px;opacity:0.4;">';
    html += '<i class="fas fa-circle-info"></i><span>\u0e1c\u0e39\u0e49\u0e23\u0e31\u0e1a\u0e15\u0e49\u0e2d\u0e07\u0e2d\u0e2d\u0e19\u0e44\u0e25\u0e19\u0e4c\u0e2d\u0e22\u0e39\u0e48\u0e43\u0e19\u0e40\u0e0b\u0e34\u0e23\u0e4c\u0e1f\u0e40\u0e27\u0e2d\u0e23\u0e4c\u0e01\u0e01\u0e48\u0e2d\u0e19</span></div>';
    html += '</div>';

    // Total summary
    html += '<div style="display:flex;align-items:center;justify-content:space-between;padding:10px 14px;background:rgba(255,255,255,0.04);border-radius:10px;border:1px solid rgba(255,255,255,0.08);">';
    html += '<span style="font-size:13px;opacity:0.6;">\u0e22\u0e2d\u0e14\u0e0a\u0e33\u0e23\u0e30</span>';
    html += '<strong id="swal-total" style="font-size:18px;color:var(--color-accent);">' + formatMoney(price) + '</strong>';
    html += '</div>';
